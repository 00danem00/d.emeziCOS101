fn main() {
    ...
    //this means the slice starts rom index 0 and goes up to index 3  (exclucive)
    ...
    //omit the start index and at the end index
    //reference the whole array
    let slice4 = &numbers[..];
    //this means the slice starts from index 0and goes up to indx 5 (exclusive)
