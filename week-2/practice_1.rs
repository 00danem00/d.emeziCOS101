fn main() {
	...
	println!("1. Distinguish between comuter and computer programming,/n
	2. Develop some techiques in computer science,/n 
	3. Understand the different areas of study in computer science,/n
	4. Conversant with aplications of computer science,/n 
